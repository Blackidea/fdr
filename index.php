...
<div class="page">
	...
	<section class="firstscreen">
		<div class="firstscreen__bg">
			<img src="img/index/firstscreen_bg.jpg" alt="@@" class="firstscreen__bg-image">
		...
		<div class="container small">
			...
			<form class="searchform">
				...
				<div class="searchform__field searchform__field_date">
					...
					<a href="#" class="calendar" data-dateopen="first_datepicker"><img src="img/icon_calendar.svg" alt="@@"></a>
		...
		<!-- Desktop -->
		<a href="#" class="firstscreen__mouseicon"><img src="img/icon_mouse.svg" alt="@@" width="24"></a>
	</section>
	...
	<section class="technics animation-off">
	    ...
	    <div class="technics__choose-type technics__choose-type_first">
	        <img src="img/nut.svg" alt="@@" class="technics__rotating-gear">
	    ...
	    <div class="technics__choose-type technics__choose-type_subtype technics__choose-type_nextwo">
	        ...
	        <ul class="technics__subtype-list">
	            <li data-image="img/index/subtype1@2x.jpg">Мини-погрузчик</li>
                <li data-image="img/index/subtype2@2x.jpg">Экскаватор-погрузчик</li>
                <li data-image="img/index/subtype3@2x.jpg">Экскаватор гусеничные</li>
                <li data-image="img/index/subtype4@2x.jpg">Экскаватор колесный</li>
                <li data-image="img/index/subtype5@2x.jpg">Бульдозер</li>
                <li data-image="img/index/subtype6@2x.jpg">Автогрейдер</li>
                <li data-image="img/index/subtype7@2x.jpg">Фронтальный погрузчик</li>
                <li data-image="img/index/subtype8@2x.jpg">Каток грунтовый</li>
                <li data-image="img/index/subtype9@2x.jpg">Каток дорожный</li>
                <li data-image="img/index/subtype10@2x.jpg">Асфальтоукладчики</li>
                <li data-image="img/index/subtype11@2x.jpg">Гудронаторы</li>
                <li data-image="img/index/subtype12@2x.jpg">Дорожные фрезы</li>
                <li data-image="img/index/subtype13@2x.jpg">Поливомоечная машина</li>
                <li data-image="img/index/subtype14@2x.jpg">Трактор</li>
	        </ul>
	    </div>
        ...
        <div class="technics__fullfilter">
	        <p>Расширенный фильтры<span class="technics__fullfilter-arrow"><img src="img/calculator/filter-open-arrow.svg" width="34" alt="@@"></span></p>
	    </div>
	    ...
	    <div class="technics__additionals">
            ...
            <div class="technics__additionals-list">
                <a href="#" class="technics__additional">
                    ...
                    <div class="technics__additional-img"><img src="img/technics_1.jpg" alt="@@"></div>
                </a>
