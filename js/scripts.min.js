...
$(".burgermenu .close-button").click(function(){
...
$(".burgermenu .rentmenu").click(function(){
	$(".burgermenu .lists").fadeOut();
	$(".burgermenu .rent").fadeIn();
});

$(".burgermenu .listmenu").click(function(e){
	e.preventDefault();
	$(".burgermenu .rent").fadeOut();
	$(".burgermenu .lists").fadeIn();
});
...
$(".faq__categorylist a").click(function(e){
	...
	var href = $(this).attr("href");	$(this).parents("li").find(".faq__hiddenlist").slideToggle();
