...
<section class="pagesalespage">
	<div class="container">
		<p class="toptext"><a href="sales.php"><img src="img/arrow_green_left.svg" alt="@@" width="31" class="bounce">Все акции</a></p>
	</div>
	<div class="sale__bg">
		<!-- Mobile -->
		...
		<div class="sale__desktopblock">
			<p class="small">с 03.09.16-15.10.16</p>
	...
	<div class="content">
		<div class="container">
			...
			<div class="icons icons_aside">
				<a href="#">
					<img src="img/vkontakte.svg" alt="@@" width="25">
				</a>
				<a href="#">
					<img src="img/facebook.svg" alt="@@" width="10">
				</a>
				<a href="#">
					<img src="img/twitter.svg" alt="@@" width="21">
				</a>
				<a href="#">
