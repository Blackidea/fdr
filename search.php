	...
	<form class="searchform">
		<div class="container">
			...
			<div class="searchform__field searchform__field_date">
				...
				<a href="#"><img src="img/icon_calendar.svg" alt="@@" width="26"></a>
			</div>
			<div class="searchform__field">
				<input type="text" name="workplace" value="г. Москва, 3-я Владимирская ул.">
			</div>
			<a href="#" class="button"><span class="button__border-top"></span>Фильтр<span class="button__border-bottom"></span></a>
		</div>
	</form>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCUaCNfcDZQL7nZK07DQmAHsEetCCMIQ5w&callback=initMap"></script>
        ...
        <script type="text/javascript">
            ...
            function initMap() {
                ...
                var mapElement = document.getElementById('searchresultmap');
