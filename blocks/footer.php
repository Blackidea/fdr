<footer class="footer">
	<div class="container">
		...
		<div class="footer__middle-part">
			...
			<form action="send.php" method="post" class="footer__form">
				...
				<button type="submit"><img src="img/icon_arrow_right_3.svg" alt="@@" width="47"></button>
			</form>
		</div>
	</div>
	<div class="footer__bottom-part">
		<div class="container">
			<p>© Foderent, 2016</p>
			<p>Разработка и продвижение сайта — <a href="http://blackidea.net/" target="_blank"><img src="img/logo_blackidea.svg" alt="@@"></a></p>
		</div>
	</div>
