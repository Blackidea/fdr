...
<section class="account">
	<div class="small-page-heading">
      ...
      <?php include "blocks/acc-topnav2.php"; ?>
		</div>
	</div>
  ...
  <!-- ########## Техника ########## -->
	...
	<?php include "blocks/acc-technics.php"; ?>

	<!------------------------------------------------->
  <!-- ########## Техника (информация) ########## -->

	<?php include "blocks/acc-technicsinfo.php"; ?>

	<!------------------------------------------------->
  <!-- ########## Операторы ########## -->

	<?php include "blocks/acc-operators.php"; ?>

	<!------------------------------------------------->
  <!-- ########## Операторы (информация) ########## -->

  <?php include "blocks/acc-operatorsinfo.php"; ?>
  ...
  <?php include "blocks/acc-bottomnav2.php"; ?>
</section>
