<header class="header">
	...
	<div class="header__icons">
		...
		<!-- Desktop -->
		<a href="#" class="header__icon authorized message"><img src="img/icon_message.png" alt="@@"><span>3</span></a>
		<!-- Desktop -->
		<a href="#" class="header__icon authorized"><img src="img/icon_person.png" alt="@@"></a>
		<a href="#" class="header__icon" data-action="toggleheadersearch"><img src="img/icon_loupe.svg" alt="@@"></a>
		<!-- Desktop 1200 -->
		<a href="#" class="button button_small button_green login" style="display:none"><span class="button__border-top"></span>Вход / Регистрация<span class="button__border-bottom"></span></a>
	</div>
