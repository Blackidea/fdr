<div class="account__technics-info page-of-account">
<div class="container container_technicsinfo">
  <div class="accountpage__contentblock">

  <div class="container container_active">
    <p class="toptext"><a data-change-account="technics"><img src="img/arrow_green_left.svg" alt="@@" width="31" class="bounce">Вся техника</a></p>
  ...
  <div class="account__technics-infomap">
    ...
    техники</p>
    <div class="container account__technics-infocontainer"><input type="text" placeholder="Введите адрес"></div>
